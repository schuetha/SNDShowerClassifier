...
then
    ...
    export ALIBUILD_WORK_DIR=/afs/cern.ch/user/s/schuetha/work/private/GNN/sw
...
python3 /afs/cern.ch/user/s/schuetha/work/private/GNN/FCGNN/GNN_flavour_oh_ori.py