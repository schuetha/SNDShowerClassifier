...
# ./FCGNN/evaluates.sh 150 FCGNN/SNDShowerClassifier_Full_FC_RC_RD.yaml SNDShowerClassifier_Full_FC_RD_300cut 4 32
...
export TORCH_EXTENSIONS_DIR=/afs/cern.ch/user/s/schuetha/work/public/SNDShowerClassifier/Forward_Centrality_Transformer/torch_extensions_cache
...
# Run
python3 -u "$pwds/evaluates.py" -e $epoch -b $batch_size -m "$pwds/${config}" -o "$pwds/$out_path"
