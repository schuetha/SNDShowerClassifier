...
# python3 GNN_data_loader_oh_ori.py

# ---------- main ----------
if __name__ == "__main__":
    # data = torch.load("/eos/user/s/schuetha/GNN_data.pt", map_location="cpu")
    data = torch.load("/eos/user/s/schuetha/signal_background_data_new_dataset_with_time_300_cut/GNN_data_train_small_correct_all_flavour.pt", map_location="cpu")
    ...
    base_out = "/eos/user/s/schuetha/signal_background_data_loader_all_flavour_oh_ori_300_cut"
